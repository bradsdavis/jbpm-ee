...
public interface TaskServiceRest {
    ...
    JaxbTaskSummaryListResponse getTasksAssignedAsBusinessAdministrator(@PathParam("userId") String userId, String language);

    @PUT
    @Path("assigned/{userId}/potential/all")
    JaxbTaskSummaryListResponse getTasksAssignedAsPotentialOwner(@PathParam("userId") String userId, String language);


    @PUT
    @Path("assigned/{userId}/potential/status")
    JaxbTaskSummaryListResponse getTasksAssignedAsPotentialOwnerByStatus(@PathParam("userId") String userId, List<Status> status, String language);


    @PUT
    @Path("assigned/{userId}/owner/all")
    JaxbTaskSummaryListResponse getTasksOwned(@PathParam("userId") String userId, String language);


    @PUT
    @Path("assigned/{userId}/owner/status")
    JaxbTaskSummaryListResponse getTasksOwnedByStatus(@PathParam("userId") String userId, List<Status> status, String language);
    ...
    JaxbTaskSummaryListResponse getTasksByStatusByProcessInstanceId(@PathParam("processInstanceId") long processInstanceId, List<Status> status, String language);
